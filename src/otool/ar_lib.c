...
/*   Updated: 2017/11/29 18:49:48 by fkoehler         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "otool.h"

static void	browse_lib_ar(t_otool *env, uint32_t *ar_offset_array,
uint32_t array_len)
{
	uint32_t		i;
...
void		handle_lib_ar(t_otool *env, struct ranlib *libtab, uint32_t libsize)
{
	uint32_t	i;
	uint32_t	j;
